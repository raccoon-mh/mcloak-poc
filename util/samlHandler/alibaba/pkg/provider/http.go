...
import (
	...
	"gocloak/util/samlHandler/alibaba/pkg/cfg"
	"gocloak/util/samlHandler/alibaba/pkg/cookiejar"
	"gocloak/util/samlHandler/alibaba/pkg/dump"
...
func (hc *HTTPClient) Do(req *http.Request) (*http.Response, error) {
	...
	req.Header.Set("User-Agent", fmt.Sprintf("saml2alibabacloud/0.0.5 (%s %s)", runtime.GOOS, runtime.GOARCH))
